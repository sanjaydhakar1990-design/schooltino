...
agent_communication:
  - agent: "main"
    message: "🚀 ADMIT CARD SYSTEM ENHANCED! New features: 1) Class-wise auto subjects (Nursery to 12th) 2) Class-wise instructions 3) Fee requirement types (no_requirement/percentage/all_clear) 4) Admin manual activation with reason 5) Bulk activation 6) Publish with notifications 7) StudyTino student download 8) Online/Cash payment support 9) Fee deadline with auto-activate. Please test new APIs."
  - agent: "testing"
