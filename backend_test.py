...
class SchooltinoAPITester:
    def __init__(self, base_url="https://form-submit-fix-3.preview.emergentagent.com/api"):
    ...
    def test_marketing_page_phone_number(self):
        ...
        try:
            ...
            response = requests.get("https://form-submit-fix-3.preview.emergentagent.com/marketing", timeout=10)
