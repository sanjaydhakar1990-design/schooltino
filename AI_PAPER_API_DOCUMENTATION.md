...
**Base URL:** `https://teachfixed.preview.emergentagent.com`  
...
### Request:
```bash
curl -X POST "https://teachfixed.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X POST "https://teachfixed.preview.emergentagent.com/api/ai/generate-paper" \
  -H "Content-Type: application/json" \
...
- **Method:** POST
- **URL:** `https://teachfixed.preview.emergentagent.com/api/auth/login`
- **Body:**
```json
{
  "email": "director@test.com",
...
- **Method:** POST
- **URL:** `https://teachfixed.preview.emergentagent.com/api/ai/generate-paper`
- **Headers:**
...
```bash
# Step 1: Get Token
TOKEN=$(curl -s -X POST "https://teachfixed.preview.emergentagent.com/api/auth/login" \
  -H "Content-Type: application/json" \
