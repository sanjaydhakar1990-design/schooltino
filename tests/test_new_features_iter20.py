...
Backend URL: https://code-checker-64.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://code-checker-64.preview.emergentagent.com')
