      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 max-w-md w-full">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-500">Your school has been registered. Save these login details.</p>
          </div>

          <div className="bg-blue-50 rounded-xl p-4 mb-4">
            <h3 className="font-semibold text-blue-900 text-sm mb-3 flex items-center gap-2">
              <School className="w-4 h-4" /> School Details
            </h3>
          ...
          <div className="bg-amber-50 rounded-xl p-4 mb-4 border border-amber-200">
            <h3 className="font-semibold text-amber-900 text-sm mb-3 flex items-center gap-2">
              <Shield className="w-4 h-4" /> Login Credentials (Save These!)
            </h3>
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium text-gray-900">Director (Admin)</span>
              </div>
            </div>
          </div>

          <p className="text-xs text-red-500 text-center mb-4 font-medium">Please save your password now. You can change it later from Settings.</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <div className="max-w-lg mx-auto px-4 py-8 sm:py-12">
        <div className="text-center mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Register Your School</h1>
          <p className="text-gray-600 text-sm">Fill in basic details. You can add more information later from Settings.</p>
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-green-100 text-green-700 rounded-full text-xs font-medium mt-3">
            <CheckCircle2 className="w-3.5 h-3.5" /> Password will be auto-generated for you
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="border-t border-gray-100 pt-5">
              <h3 className="text-sm font-semibold text-gray-900 mb-3 flex items-center gap-2">
                <User className="w-4 h-4 text-blue-600" /> Director / Admin Details
              </h3>
              <div className="space-y-3">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Director Name *</label>
                  <input name="director_name" value={form.director_name} onChange={handleChange} placeholder="Full name" required className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500" />
                </div>
                <div>
            ...
            <div className="bg-blue-50 rounded-xl p-3 text-xs text-blue-700 flex items-start gap-2">
              ...
              <span>A secure password will be auto-generated for you. You'll see it after registration and can change it from Settings.</span>
            </div>
            ...
            <button type="submit" className="w-full py-3.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-semibold text-sm hover:shadow-lg hover:shadow-blue-500/25 transition-all flex items-center justify-center gap-2" disabled={loading}>
              {loading ? <Loader2 className="w-4 h-4 animate-spin" /> : <>Register School <ArrowRight className="w-4 h-4" /></>}
            </button>
          </form>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <button onClick={() => navigate('/login')} className="text-blue-600 hover:text-blue-700 font-medium">Sign In</button>
        </p>
      </div>
    </div>
  );
