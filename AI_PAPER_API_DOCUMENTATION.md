...
**Base URL:** `https://form-submit-fix-3.preview.emergentagent.com`  
...
### Request:
```bash
curl -X POST "https://form-submit-fix-3.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X POST "https://form-submit-fix-3.preview.emergentagent.com/api/ai/generate-paper" \
  -H "Content-Type: application/json" \
...
- **Method:** POST
- **URL:** `https://form-submit-fix-3.preview.emergentagent.com/api/auth/login`
- **Body:**
```json
{
  "email": "director@test.com",
...
- **Method:** POST
- **URL:** `https://form-submit-fix-3.preview.emergentagent.com/api/ai/generate-paper`
- **Headers:**
...
```bash
# Step 1: Get Token
TOKEN=$(curl -s -X POST "https://form-submit-fix-3.preview.emergentagent.com/api/auth/login" \
  -H "Content-Type: application/json" \
